...
const PlayList = ({ navbarItems, handleNavigate }) => {
  ...
  const data = [
    ...
    { id: '3',  title: 'Video 3', video: 'https://filesamples.com/samples/video/mp4/sample_640x360.mp4' },
    { id: '4',  title: 'Video 4', video: 'https://media.w3.org/2010/05/sintel/trailer.mp4' },
    { id: '5',  title: 'Video 5', video: 'https://archive.org/download/ElephantsDream/ed_1024_512kb.mp4' },
  ];
